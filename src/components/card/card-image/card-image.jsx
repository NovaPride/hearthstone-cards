  ...
  useEffect(() => {
    ...
    if (isObject(src)) {
      ...
      ref.current = png ? png : 
                      large ? large :
                        normal ? normal :
                          small ? small : "https://wallpapers.com/images/featured/funny-memes-picture-rzemn8642wst0ckw.jpg";
    } else if(typeof src === "undefined" || typeof src === "null") {
      ref.current = "https://wallpapers.com/images/featured/funny-memes-picture-rzemn8642wst0ckw.jpg";
    } else {
      ref.current = src;
    }
